...
class GateMotorInterfaceFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.car_image = wx.StaticBitmap( self.m_panel1, wx.ID_ANY, wx.Bitmap( u"imgs/car.png", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer4.Add( self.car_image, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.gate_image = wx.StaticBitmap( self.m_panel1, wx.ID_ANY, wx.Bitmap( u"imgs/gate.jpg", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_bpButton1 = wx.BitmapButton( self.m_panel5, wx.ID_ANY, wx.Bitmap( u"imgs/control.PNG", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW )
